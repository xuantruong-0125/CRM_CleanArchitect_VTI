...
public interface ActivityRepository  {
    ...
    PagedResult<Activity> findAll(Pagination pagination, Long currentUserId,Long organizationId, String scope);

    Optional<Activity> findById(Long id);

    PagedResult<Activity> findByCriteria(ActivitySearchCriteria criteria, Pagination pagination, Long currentUserId,Long organizationId, String scope);
}
