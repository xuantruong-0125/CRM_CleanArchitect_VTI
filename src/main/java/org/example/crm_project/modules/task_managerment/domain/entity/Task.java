...
public class Task {
    ...
    public Task(Long id, String subject, String description, LocalDateTime startDate, LocalDateTime dueDate,
            ...
            String relatedToType, Long relatedToId, Long assignedTo, Long assignedBy, Long contactId,
    ...
    private void handleStatusAndProgressLogic(TaskStatus newStatus, Integer newProgress) {
        ...
        if (newProgress != null) this.progressPercent = newProgress;

        // Luật 1: Nếu kéo thanh tiến độ lên 100% -> Tự động chuyển trạng thái thành Hoàn thành
        if (this.progressPercent != null && this.progressPercent == 100) {
            this.status = TaskStatus.COMPLETED;
        }

        // Luật 2: Nếu bấm nút "Đã hoàn thành" -> Tiến độ auto nhảy lên 100% và ghi nhận giờ
        ...
        // Luật 3: "Quay xe" - Trạng thái không phải Hoàn thành thì không được có giờ hoàn thành
        else {
            this.completedAt = null;
        }

        // Luật 4: Nếu đang "Chưa bắt đầu" nhưng lại điền tiến độ > 0 -> Tự động ép sang "Đang tiến hành"
